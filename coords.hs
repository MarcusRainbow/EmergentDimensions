...
-- |dimension first
dimension_ranges :: VV.Vector (Vector Float) -> Either String [Float]
...
foldr_axes :: (Float -> a -> a) -> a -> VV.Vector (Vector Float) -> [a]
...
foldr_axis :: (Float -> a -> a) -> Int -> a -> VV.Vector (Vector Float) -> a
...
-- |between points.
validated_coords :: VV.Vector (Vector Float) -> Either String (VV.Vector (Vector Float))
...
test_dimension_ranges_simplex ::  StatefulGen g m => g -> Int -> m (Either String [Float])
